    ...
    >
      ...
      <Box className={classes.educationWrapper}>
        <Box className={classes.educationContent}>
          ...
          <Box className={classes.institution}>{education?.institution}</Box>
        </Box>
        <Box className={classes.educationFooter}>
          <Tooltip title={education.degree} placement="top">
            <Avatar className={classes.avatar} alt="education leader" />
          </Tooltip>
          <Typography className={classes.updateDate}>
            Updated: {moment(education.createdAt).format("lll")}
          </Typography>
        </Box>
      </Box>
    </Card>
