...
import projectCover from "../../../../assets/icons/react-js.svg";
...
export function ProjectCard({ project }) {
  ...
  return (
    <Card
      ...
      component={Link}
      to={PATH_DASHBOARD.projectDetail(project._id)}
    >
      ...
      <Box className={classes.projectWrapper}>
        <Box className={classes.projectContent}>
          ...
          <Box className={classes.institution}>{project?.description}</Box>
        </Box>
        <Box className={classes.projectFooter}>
          ...
          <Typography className={classes.updateDate}>
            Updated: {moment(project.createdAt).format("lll")}
          </Typography>
        </Box>
      </Box>
    </Card>
